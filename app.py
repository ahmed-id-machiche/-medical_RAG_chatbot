...
if page == "Chatbot Tbibk":
    ...
    st.markdown(f"""
    <div class="premium-card" style="margin-bottom: 25px; padding: 25px;">
        <span style="font-size: 16px; color: #1E3A8A; font-weight: 800; text-align: center; display: block; margin-bottom: 20px; font-family: 'Outfit', sans-serif;">
            FICHE CLINIQUE DE CONSULTATION | بطاقة الاستشارة الطبية
        </span>
        <table style="width: 100%; border-collapse: collapse; font-family: 'Inter', sans-serif;">
            <thead>
                <tr style="border-bottom: 2px solid #CBD5E1; background-color: #F8FAFC;">
                    <th style="padding: 12px 10px; text-align: left; font-weight: 700; color: #1E293B; width: 55%;">Indicateur Évalué (المؤشر السريري)</th>
                    <th style="padding: 12px 10px; text-align: right; font-weight: 700; color: #1E293B; width: 45%;">Résultat & Statut (النتيجة والتقييم)</th>
                </tr>
            </thead>
            <tbody>
                <tr style="border-bottom: 1px solid #E2ECF2;">
                    <td style="padding: 12px 10px; font-weight: 600; color: #334155;">Poids / Taille (الوزن والطول)</td>
                    <td style="padding: 12px 10px; text-align: right; font-weight: 700; color: #111827;">{st.session_state.poids:.1f} kg / {st.session_state.taille:.1f} cm</td>
                </tr>
                <tr style="border-bottom: 1px solid #E2ECF2;">
                    <td style="padding: 12px 10px; font-weight: 600; color: #334155;">Indice de Masse Corporelle (IMC / مؤشر كتلة الجسم)</td>
                    <td style="padding: 12px 10px; text-align: right; font-weight: 700; color: {imc_color};">{imc:.1f} ({imc_status})</td>
                </tr>
                <tr>
                    <td style="padding: 12px 10px; font-weight: 600; color: #334155;">Risque Cardiovasculaire (HTA / خطر القلب والضغط)</td>
                    <td style="padding: 12px 10px; text-align: right; font-weight: 700; color: {risk_color};">{risk_status}</td>
                </tr>
            </tbody>
        </table>
    </div>
